...
import com.veskoiliev.matchers.RecordedRequestMatchers
import com.veskoiliev.matchers.RecordedRequestMatchers.oneCallTo
import com.veskoiliev.rule.mockwebserver.MockResponseBuilder
...
abstract class ApiServerArrangements(private val serverRule: MockWebServerRule) {
    ...
    fun respondOn(requestMatcher: Matcher<in RecordedRequest>, response: MockResponseBuilder) {
        serverRule.responds(response).on(oneCallTo(requestMatcher))
    }
